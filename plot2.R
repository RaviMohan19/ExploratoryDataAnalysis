...
plot(power_subset$Time,as.numeric(as.character(power_subset$Global_active_power)),type="l",xlab="Days",ylab="Global Active Power (kilowatts)")
title(main="Global Active Power Vs Days")